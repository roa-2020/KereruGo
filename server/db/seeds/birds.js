...
// Inserts seed entries
    .then(() => knex("birds").insert([
      ...
      },
      {
        ...
        bird_img: "/images/2-piwakawaka.png",
        bird_rarity: "common",
        bird_nocturnal: false,
